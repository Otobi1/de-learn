...
c = a + b
print(f'the results of a + b is: {c}')
...
# You can import library or your code from another file with the import statement
...
# NOTE: in the except block its preferred to specify the exact error/exception that you want to handle
